...
<?php								if ($ftpserver["inputType"] == "text") { ?>
									<input type="text" name="ftpserver" readonly="readonly" value="<?php echo $ftpserver["list"][1]; ?>" style="width:230px;" />
...
<?php								if ($ftpserverport["inputType"] == "text") { ?>
									&nbsp; port <input size="3" maxlength="5" name="ftpserverport" readonly="readonly" value="<?php echo $ftpserverport["value"]; ?>" type="text" /> 
<?php								} else { ?>
...
<?php /* ----- Login button ----- */ ?>
						<tr>
							<td></td>
							<td colspan="2" style="padding-<?php echo __("left"); ?>: 0px;padding-top:10px;"> 
...
<?php /* ----- Clear cookies and Admin link ----- */ ?>
				...
				<input name="anonymous"  value="1" type="hidden" />
				<input name="directory" value="" type="hidden" />
			</form>
