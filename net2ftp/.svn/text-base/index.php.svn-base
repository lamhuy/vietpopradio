...
$root = getcwd();
//print ($root);
define("NET2FTP_APPLICATION_ROOTDIR", $root);
define("NET2FTP_APPLICATION_ROOTDIR_URL", "http://vietpopradio.com/net2ftp");
...
<title>Viet Pop Radio - Music Admin Portal</title>
