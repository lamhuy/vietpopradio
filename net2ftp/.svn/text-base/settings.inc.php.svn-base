...
$net2ftp_settings["email_feedback"] = "vietpopradio@gmail.com";
...
$net2ftp_settings["admin_password"] = "Password1!";
...
$net2ftp_settings["message_browse"] = "Viet Pop Radio Music Administrator Only!";
