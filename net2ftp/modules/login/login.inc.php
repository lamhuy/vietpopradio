...
// or else with the value from the cookie
		...
		// lamlh - prefill with vietpopradio.com
		$ftpserver["list"][1] = "vietpopradio.com";
...
// Check vietpopradio.com passivemode by default
...
// ------------------------------------
	...
	// ssl checked by default
	$sslconnect["checked"] = "checked=\"checked\""; 
